...
-record(daemon, {port, name, cmd, kill, errors=[], buf=[]}).
...
test() ->
    ...
    test_halts("baz", die_quickly(), 3500),
...
check_dead(D, Name, Cmd) ->
    ...
    etap:is(D#daemon.errors, halted, "Daemon has been halted."),
